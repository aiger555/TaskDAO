...
public class HomeworkTask extends Task {
    ...
    public HomeworkTask(String taskName, String taskDescription, Priority priority, boolean completed, Date deadline) {
    ...
    public String toString() {
        ...
        return "Homework Task: " + getTaskName() + " - " + getTaskDescription() +
